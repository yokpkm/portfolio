        ...
        >
          <Col span={24} style={{ maxWidth: 864 }}>
            <Row gutter={(xs || sm || md) && !lg ? [0, 32] : [0, 48]}>
              <Col span={24}>
                <TextHeadline>Cyptocurrency Application</TextHeadline>
              </Col>
              ...
              <Col xs={24} sm={11} md={11} lg={9} xl={9} xxl={9}>
                ...
                <TextCaption style={{ marginTop: 4 }}>
                  UI Design, Design System, UX Writing, Figma
                </TextCaption>
              </Col>
              ...
              <Col span={24}>
                <TextLabel style={{ marginTop: 24 }}>RESEARCH</TextLabel>
                <TextModalTitle>
              ...
              <Col span={24}>
                ...
                <TextModalContent style={{ marginTop: 8 }}>
                  Based on the research, I designed a primary persona focusing
