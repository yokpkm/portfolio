          ...
          <Col span={24} style={{ maxWidth: 864 }}>
            <Row gutter={(xs || sm || md) && !lg ? [0, 32] : [0, 48]}>
              ...
              <Col xs={24} sm={12} md={12} lg={11} xl={11} xxl={11}>
                ...
                <TextCaption style={{ marginTop: 4 }}>
                  UI Design, UX Research, React TypeScript, Figma, VS Code
                </TextCaption>
              </Col>
              <Col span={24}>
                <Row justify="center">
              ...
              <Col span={24}>
                ...
                <TextModalContent style={{ marginTop: 4 }}>
                  ...
                  , with a focus on creating intuitive and responsive interfaces
                  across platforms. I had the opportunity to{" "}
                  <b
                    style={{
                      fontWeight: 500,
                    }}
                  >
                    implement responsive layouts and develop reusable components
                  </b>{" "}
                  using React TypeScript, React Native, Next.js and Styled
                  Components.
                </TextModalContent>
              </Col>
              <Col span={24}>
              ...
              <Col span={24}>
                ...
                <TextModalContent style={{ marginTop: 4 }}>
                  ...
                  to support API development, which deepened my understanding of
                  how design decisions connect to back-end logic.
                </TextModalContent>
              </Col>
              <Col span={24}>
                <Row justify={xs && !sm ? "start" : "center"}>
