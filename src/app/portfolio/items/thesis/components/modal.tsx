              ...
              >
                <Col span={24} style={{ maxWidth: 864 }}>
                  <Row gutter={(xs || sm || md) && !lg ? [0, 32] : [0, 48]}>
                    <Col span={24}>
                      <TextHeadline>
                        Tracking Progress Web Application
                      </TextHeadline>
                    </Col>
                    ...
                    <Col span={24}>
                      ...
                      <TextModalContent style={{ marginTop: 8 }}>
                        ...
                        Science-Multimedia field create a tracking progress
                        system, communicate in real time, and manage related
                        documents in a shared system. The goal is to ensure all
                        users can effectively organize and easily access project
                        information.
                      </TextModalContent>
                    </Col>
                    <Col span={24}>
                      ...
                      <TextModalContent style={{ marginTop: 8 }}>
                        ...
                        application using Adobe XD for wireframes and
                        prototypes, collaborating closely with users to define
                        the design and ensure it met their expectations.
                      </TextModalContent>
                    </Col>
                    ...
                    <Col span={24}>
                      ...
                      <TextModalContent style={{ marginTop: 8 }}>
                        I conducted semi-structured, open-ended interviews with
                        6 teachers from Applied Computer Science-Multimedia
                        field to understand their pain points when advising
                        student projects.
                      </TextModalContent>
                    </Col>
                    <Col span={24}>
                      ...
                      <Row align="middle" style={{ marginTop: 12 }}>
                        <TextModalContent>
                          ...
                          – No shared system for storing project files, leading
                          to disorganization
                        </TextModalContent>
                      </Row>
                      <Row align="middle" style={{ marginTop: 12 }}>
                        <TextModalContent>
                          ...
                          – Lack of real-time updates, causing delays in
                          feedback
                        </TextModalContent>
                      </Row>
                    </Col>
                    <Col span={24}>
                      ...
                      <TextModalContent style={{ marginTop: 4 }}>
                        ...
                        progress, managing documents efficiently without a
                        shared system, and lacking real-time communication.
                        These challenges lead to disorganization and make
                        project information harder to access.
                      </TextModalContent>
                    </Col>
                    <Col span={24}>
                      ...
                      <Row align="middle" style={{ marginTop: 12 }}>
                        <Col>
                          <TextModalContent>
                            ...
                            – View a quick overview and navigate easily to the
                      ...
                      <Row align="middle" style={{ marginTop: 12 }}>
                        <Col>
                          <TextModalContent>
                            ...
                            – Manage group members and upload progress files
                            from students
                          </TextModalContent>
                        </Col>
                      </Row>
                    ...
                    <Col span={24}>
                      ...
                      <TextModalContent style={{ marginTop: 8 }}>
                        This web application follows a hierarchical structure,
                        where each project branches into key sections like news,
                        document, group, and progress. This ensures clear and
                    ...
                    <Col span={24}>
                      ...
                      <TextModalContent style={{ marginTop: 4 }}>
                        Feedback is gathered from teachers and students through
                        demo testing and Google Form evaluation. The summary of
                        user satisfaction is as follows:
                      </TextModalContent>
                    </Col>
                    ...
                    <Col span={24}>
                      <Row align="middle">
                        <TextModalContent>
                          ...
                          – Quick, accurate data verification, and dependable
                          data collection
                        </TextModalContent>
                      </Row>
                      <Row align="middle" style={{ marginTop: 12 }}>
                        <TextModalContent>
                          ...
                          – Intuitive system with sufficient and reliable
                          features
                        </TextModalContent>
                      </Row>
                      <Row align="middle" style={{ marginTop: 12 }}>
                        <TextModalContent>
                          ...
                          – Trusted login via university email with proper
                          access control
                        </TextModalContent>
                      </Row>
                      <Row align="middle" style={{ marginTop: 12 }}>
                      ...
                      <Row align="middle" style={{ marginTop: 12 }}>
                        <TextModalContent>
                          ...
                          – Improved project management and reduced resource
                          usage
                        </TextModalContent>
                      </Row>
                      <Row align="middle" style={{ marginTop: 12 }}>
                    ...
                    <Col span={24}>
                      ...
                      <Row align="middle" style={{ marginTop: 12 }}>
                        <TextModalContent>
                          ...
                          Add web notification for progress updates between
                      ...
                      <Row align="middle" style={{ marginTop: 12 }}>
                        <TextModalContent>
                          ...
                          Optimize data display for high user volumes by
                          limiting visible comments
                        </TextModalContent>
                      </Row>
                    </Col>
                  </Row>
