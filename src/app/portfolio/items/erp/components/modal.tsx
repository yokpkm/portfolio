                  ...
                  <Row gutter={(xs || sm || md) && !lg ? [0, 32] : [0, 48]}>
                    ...
                    <Col span={24}>
                      ...
                      <TextModalContent style={{ marginTop: 8 }}>
                        This ERP system supports e-commerce operations by
                        managing products, orders, and sales processes through 3
                        key features:
                      </TextModalContent>
                      <Row align="middle" style={{ marginTop: 12 }}>
                        <TextModalContent>
                          ...
                          product information consistent and up-to-date across
                          the platform.
                        </TextModalContent>
                      </Row>
                      <Row align="middle" style={{ marginTop: 12 }}>
                        <TextModalContent>
                          ...
                          – Handles orders by creating, tracking, and updating
                          order statuses to support smoother workflows and
                      ...
                      <Row align="middle" style={{ marginTop: 12 }}>
                        <TextModalContent>
                          ...
                          – Gathers sales inquiries and customer contact
                          information before purchases to help the team track
                          leads and follow up with personalized interactions.
                        </TextModalContent>
                      </Row>
                    </Col>
                    <Col span={24}>
                      ...
                      <TextModalContent style={{ marginTop: 8 }}>
                        ...
                        create a prototype for usability testing before
                        development.
                      </TextModalContent>
                    </Col>
                    <Col span={24}>
                      ...
                      <TextModalContent style={{ marginTop: 8 }}>
                        As part of the UX research, I conducted contextual
                        inquiry interviews through on-site observations and
                        conversations with sales, warehouse, and business teams
                        to understand their workflows related to order
                        management.
                      </TextModalContent>
                    </Col>
                    <Col span={24}>
                      ...
                      <Row align="middle" style={{ marginTop: 12 }}>
                        <Col>
                          <TextModalContent>
                            ...
                            – Lack of real-time order status visibility across
                            teams
                          </TextModalContent>
                        </Col>
                      </Row>
                      <Row align="middle" style={{ marginTop: 12 }}>
                        <TextModalContent>
                          ...
                          – No prioritization system for urgent or high-value
                          orders
                        </TextModalContent>
                      </Row>
                      <Row align="middle" style={{ marginTop: 12 }}>
                    ...
                    <Col span={24}>
                      ...
                      <TextModalContent style={{ marginTop: 4 }}>
                        ...
                        making tracking difficult. There is no system to
                        prioritize urgent orders or automate status and
                        inventory updates. Additionally, manual data entry slows
                        reporting and delays decisions.
                      </TextModalContent>
                    </Col>
                    <Col span={24}>
                      ...
                      <TextModalContent style={{ marginTop: 4 }}>
                        ...
                        orders, automates status updates, and reduces manual
                        data entry for efficient order management.
                      </TextModalContent>
                    </Col>
                    <Col span={24}>
                      ...
                      <TextModalContent style={{ marginTop: 4 }}>
                        The design applies primary and neutral colors for a
                        clean look, while semantic colors clearly communicate
                        statuses and Noto Sans is used as the primary typeface
                        to ensure readability for content.
                      </TextModalContent>
                    </Col>
                    <Col span={24}>
                      <Row justify="center">
                    ...
                    <Col span={24}>
                      <TextModalContent style={{ marginTop: 4 }}>
                        ...
                        and adapting smoothly to various screen sizes and
                        devices.
                      </TextModalContent>
                    </Col>
                    ...
                    <Col span={24}>
                      ...
                      <TextModalContent style={{ marginTop: 4 }}>
                        Users can add new product items and sync product data
                        from marketplaces such as Shopee and Lazada, ensuring
                        consistent details and inventory across platforms.
                      </TextModalContent>
                    </Col>
                    <Col span={24}>
                    ...
                    <Col span={24}>
                      ...
                      <TextModalContent style={{ marginTop: 4 }}>
                        ...
                        status and resolve order issues efficiently, ensuring
                        smooth workflows and improved team collaboration.
                      </TextModalContent>
                    </Col>
                    <Col span={24}>
                      <Row justify={xs && !sm ? "start" : "center"}>
                    ...
                    <Col span={24}>
                      ...
                      <TextModalContent style={{ marginTop: 4 }}>
                        Users can efficiently track leads from sales inquiries
                        by customer ID through sales channels and gather
                        customer contact information for personalized follow-up
                        before purchases.
                      </TextModalContent>
                    </Col>
                    <Col span={24}>
                    ...
                    <Col span={24}>
                      ...
                      <TextModalContent style={{ marginTop: 4 }}>
                        ...
                        to support API development, which deepened my
                        understanding of how design decisions connect to
                        back-end logic.
                      </TextModalContent>
                    </Col>
                    <Col span={24}>
                    ...
                    <Col span={24}>
                      ...
                      <TextModalContent style={{ marginTop: 4 }}>
                        ...
                        identify areas for improvement. The following features
