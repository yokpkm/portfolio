                  ...
                  <Row gutter={(xs || sm || md) && !lg ? [0, 32] : [0, 48]}>
                    ...
                    <Col span={24}>
                      ...
                      <TextModalContent style={{ marginTop: 8 }}>
                        ...
                        responsible for designing key new features to improve
                        user experience in security, market monitoring, and
                        portfolio tracking. Due to the project being under an
                        NDA (Non-Disclosure Agreement), some visual assets and
                        specific data are kept confidential.
                      </TextModalContent>
                    </Col>
                    <Col span={24}>
                      <TextLabel style={{ marginTop: 24 }}>
                      ...
                      <TextModalContent style={{ marginTop: 8 }}>
                        ...
                        revealed that users worry about asset safety, missing
                        price changes, and difficulty understanding their
                        trading outcomes.
                      </TextModalContent>
                    </Col>
                    <Col span={24}>
                      ...
                      <TextModalContent style={{ marginTop: 8 }}>
                        User personas were developed based on research insights
                        to reflect user goals, pain points, and behaviors that
                    ...
                    <Col span={24}>
                      ...
                      <TextModalContent style={{ marginTop: 4 }}>
                        ...
                        insights into profit and loss. Most platforms offer
                        limited personalized, intuitive tools for quick decision
                        making in a volatile market.
                      </TextModalContent>
                    </Col>
                    <Col span={24}>
                      ...
                      <Row align="middle" style={{ marginTop: 12 }}>
                        <Col>
                          <TextModalContent>
                            ...
                            – give users clarity and confidence in tracking
                    ...
                    <Col span={24}>
                      ...
                      <TextModalContent style={{ marginTop: 4 }}>
                        Working on new features showed how UI consistency
                        enhances usability and trust, especially in crypto
                        trading platforms. Ensuring consistency{" "}
                        <b
                          style={{
                            fontWeight: 500,
                          }}
                        >
                          requires alignment across UI design, design system,
                          and UX writing
                        </b>
                    ...
                    <Col span={24}>
                      ...
                      <TextModalContent style={{ marginTop: 4 }}>
                        I learned how effective collaboration with product
                        owners, business analysts, developers, and QA engineers
                        leads to better issue resolution and smoother handoffs.
                        The communication and open discussion helped{" "}
                        <b
                          style={{
                            fontWeight: 500,
                          }}
                    ...
                    <Col span={24}>
                      ...
                      <TextModalContent style={{ marginTop: 4 }}>
                        Usability testing was conducted internally with
                        stakeholders to validate the concept and clarity. The
                        following are planned for the next phase:
                      </TextModalContent>
                      <Row align="middle" style={{ marginTop: 12 }}>
                        <TextModalContent>
                          <b
                      ...
                      <Row align="middle" style={{ marginTop: 12 }}>
                        <TextModalContent>
                          ...
                          Enable sharing options for alerts and trading
                          summaries within the community
                        </TextModalContent>
                      </Row>
                      <Row align="middle" style={{ marginTop: 12 }}>
                        <TextModalContent>
                          ...
                          Implement personalization options to customize alerts
